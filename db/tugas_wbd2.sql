...
--
-- Host: localhost    Database: tugas_wbd2
-- ------------------------------------------------------
...
CREATE TABLE `barang_data` (
  `barang_id` int(5) NOT NULL AUTO_INCREMENT,
