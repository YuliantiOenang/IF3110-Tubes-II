...
if(typeof(Storage)!=="undefined"){
	if(localStorage.wbduser){
		...
		xmlhttp.open("POST","ajaxprofile",true);
...
<article id="featured" class="body">
		<h2 id="headername"></h2>
		<form id="registerform" method="post" action="editprofilesave" enctype="multipart/form-data">
		<pre>(*) Harus diisi.</pre>
		...
		<input type="button" onclick="ceksama()" value="Save"> <a href='profile.jsp'>Kembali</a></form>
</article><!-- /#featured -->
