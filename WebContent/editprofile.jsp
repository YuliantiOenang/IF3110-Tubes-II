...
<body>
	...
	<form method="post" onsubmit="return validateAll()" action="user"
		...
		<div class='register_div'>
			...
			<div class="per_form">
				<label>Nama Lengkap</label><input type="text" value="" name="name"
					id="name" required
					onkeyup="if(this.value != '') validateName(this.value, 'fullname');">
				<span class="error" id="fullname"></span>
			</div>
			<div class="per_form">
				<label>Password Baru</label><input type="password" value=""
					name="password1" id="password1"
					onkeyup="if(this.value != '') validatePassword(this.value, password2.value, username.value, email.value, 'valpasswords');">
				<span class="error" id="valpassword"></span>
			</div>
			<div class="per_form">
				<label>Confirm Pass.</label><input type="password" value=""
					name="password2" id="password2"
					onkeyup="if(this.value != '') validatePassword(password1.value, this.value, username.value, email.value, 'valpasswords');">
		...
		<div class='register_div'>
			<div class='per_form small'>
				<label class='uncheck'>Alamat</label><input type="text"
					...
					onkeyup="validateEmpty(this.value, 'valaddress')" required>
			...
			<div class='per_form small'>
				<label class='uncheck'>Kota/Kabupaten</label><input type="text"
					...
					onkeyup="validateEmpty(this.value, 'valcity')" required> <span
					id="valcity"></span>
			</div>
			...
			<div class='per_form small'>
				<label class='uncheck'>Kodepos</label><input type="text"
					...
					onkeyup="validateEmpty(this.value, 'valpostal')" required>
				<span id="valpostal"></span>
			</div>

			<div class='per_form small'>
				<label class='uncheck'>Telepon</label><input type="text"
					name="telephone" id="telephone" value=""
					onkeyup="validateEmpty(this.value, 'valtelephone')" required>
				<span id="valtelephone"></span>
			</div>
