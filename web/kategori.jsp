		...
		<input type="submit" value="Sort">
                ...
                if(Page==null)
                {
                    ...
                    while(i<counter && i<10 && session.getAttribute("nama"+i)!=null)
                    {
                        ...
                        + "</div>"
                        + "<a href='detailbarang.php?id="+session.getAttribute("id"+i) +"'><p class = 'copyrightext'> "+session.getAttribute("nama"+i) +"</a> </br>"
                ...
                else
                {
                    ...
                    while(counter<batas && session.getAttribute("nama"+counter)!=null)
                    {
                        ...
                        + "</div>"
                        + "<a href='detailbarang.php?id="+session.getAttribute("id"+counter) +"'><p class = 'copyrightext'> "+session.getAttribute("nama"+counter) +"</a> </br>"
