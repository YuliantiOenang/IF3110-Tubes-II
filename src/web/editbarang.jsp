	...
	<div class = "boddy">
		...
		<h1 id = "loginHeader"> EDIT BARANG</h1></br></br>
			...
			<div class = "registerspace">
                            <%Cookie idBarang = new Cookie("idBarang", request.getParameter("id"));
                            idBarang.setMaxAge(60*60*3600);
                            response.addCookie(idBarang);
                            %>
			<form method="post" ACTION="edit_barang.jsp" name="uploadForm"> 
