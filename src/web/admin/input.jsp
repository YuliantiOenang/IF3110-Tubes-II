...
<div class = "bodymain">
	...
	<div class = "boddy">
        ...
        <% 
			...
			try
			{
				...
				else
				{
					...
					fileOut.close(); 
					imageSave="Success";
					db.stat.executeUpdate(request.getParameter("query")+"'images/"+session.getAttribute("nama")+"."+parseDot[1]+"','tersedia')");
					%>
					<script>
        ...
        <form method="get" ACTION="input.jsp" > 
			...
			<label>deskripsi :</label> 	<textarea cols="35" name="deskripsi">YOUR TEXT HERE</textarea>  <br>
	   ...
	   %>
        ...
        <form method="post" ACTION="input.jsp?query=<%out.print("INSERT INTO `peralatan`(`nama`, `kategori`, `jumlah`, `harga`, `deskripsi`, `foto`, `status`) VALUES ('"+request.getParameter("nama")+"','"+request.getParameter("kategori")+"','"+request.getParameter("jumlah")+"','"+request.getParameter("harga")+"','"+request.getParameter("deskripsi")+"',");%>" name="uploadForm" ENCTYPE='multipart/form-data'> 
            <div id="op"></div>
