...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 27, 2013 at 07:06 AM
...
(17, 'Akbar Juang Saputra', 'bandung', 14045, 'hgghjg@dhkgh.hkhg', 823355975, '12345678', 'AkbarJuang', 'jabar', 'jalanan', '1234567891234560');
...
CREATE TABLE IF NOT EXISTS `keranjang` (
  ...
  UNIQUE KEY `id_keranjang` (`id_keranjang`)
...
(1, 'Browny4', 'Jaket', 1921, 400000, 'You like brown? THIS is brown! The silk is out of this world!', 'images/Browny4.gif', 'tersedia'),
...
(6, 'Viva la Vida', 'Sweater', 1921, 150000, 'Taken from limited cover art of Viva la Vida, it will show everyone that you hear Jerussalem bells are ringing!', 'images/Sweater2.jpg', 'tersedia'),
...
(11, 'Live2012', 'Sweater', 1910, 200000, 'You''ve seen Coldplay Live 2012? Tell everyone you''ve seen it with this sweater!', 'images/Sweater3.jpg', 'tersedia'),
...
(14, 'Dark Jacket2', 'Jaket', 2000, 200000, 'The darkest jacket there is', 'images/Dark Jacket2.jpg', 'tersedia'),
...
(22, 'JJJ Jacket', 'Jaket', 7058, 70000, 'For the frugals', 'images/Jaket10.jpg', ''),
...
(26, 'Mylo Xyloto', 'Sweater', 180, 150000, 'Share your favorite Coldplay concept album with this sweater!!', 'images/Sweater4.jpg', NULL),
...
(56, 'Pokemon X', 'Pokemon', 199, 450000, 'See the beauty of Kalos Region with full 3D!', 'images/Pokemon10.jpg', ''),
