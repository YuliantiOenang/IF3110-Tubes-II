					...
					<div class="frame">
						...
						<div class="kolom-6">
							...
							<div class="frame buy-bar">
								<input class="kolom-9 buy-box" type="text" id='<%str =(String)session.getAttribute("synama"+i);out.print(str);%>' name="buy" value="Banyaknya barang.." onfocus="checkclear(this)" onblur="checkempty(this, 'Banyaknya barang..')"> 
