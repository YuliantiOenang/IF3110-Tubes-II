...
<%@ include file="middle.jsp" %>
	...
	<div id="container">
		...
		<form name="registrasi">
			Username: <br><input type="text" name="username" size="40" onchange="validateForm()"><small> minimal 5 karakter</small><br>
			...
			Email: <br><input type="text" name="email" size="40" onchange="validateForm()"><br>
			Password: <br><input type="password" name="password" size="40" onchange="validateForm()"><small> minimal 8 karakter, != username dan email</small><br>
			Confirm password: <br><input type="password" name="confpassword" size="40" onchange="validateForm()"><small> == password</small><br>
